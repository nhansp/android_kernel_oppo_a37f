...
/* OPPO mdss panel-detection owns lcd_dev; not ported here. Weak default so
 * this TU links; at 0 the 15399 panel-specific transmittance tuning below
 * is skipped and the default ALS calibration is used. */
int __attribute__((weak)) lcd_dev = 0;
enum {
