...
static struct device_attribute power_supply_attrs[] = {
	...
	POWER_SUPPLY_ATTR(temp_statu),
	POWER_SUPPLY_ATTR(fast_charge_project),
	POWER_SUPPLY_ATTR(battery_fcc),
	POWER_SUPPLY_ATTR(battery_soh),
	POWER_SUPPLY_ATTR(battery_cc),
	POWER_SUPPLY_ATTR(battery_charger_enable),
	POWER_SUPPLY_ATTR(battery_notify),
