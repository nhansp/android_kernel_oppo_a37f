...
/* cabc_mode is normally owned by the OPPO MDSS DSI panel driver; provide a
 * weak fallback (CABC disabled) so the backlight links standalone until the
 * display driver supplies a strong definition. */
int __weak cabc_mode = 0;
