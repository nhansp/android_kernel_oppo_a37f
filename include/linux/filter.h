...
extern void cbpf_jit_compile(struct sk_filter *fp);
extern void cbpf_jit_free(struct sk_filter *fp);
...
#else
static inline void cbpf_jit_compile(struct sk_filter *fp)
{
}
static inline void cbpf_jit_free(struct sk_filter *fp)
{
}
...
/* =============== eBPF additive (acro lineage-23.2 5.8) =============== */
