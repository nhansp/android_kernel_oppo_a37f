...
/* eBPF backport: base 3.10 LSM has no bpf hooks; stub to permissive no-op.
 * (loader logic untouched per project constraint; arm64 passes the kver gate
 * natively + ro.bpf.kver_override target=5.10) */
struct bpf_map;
struct bpf_prog;
struct bpf_prog_aux;
union bpf_attr;
